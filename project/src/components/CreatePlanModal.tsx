...
export function CreatePlanModal({ isOpen, onClose }: CreatePlanModalProps) {
  ...
  const generatePlan = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const prompt = `Generate a comprehensive 3-day baby food plan.

BABY DETAILS:
Age: ${promptData.age} months
Height: ${promptData.height} cm
Weight: ${promptData.weight} kg
Sex: ${promptData.sex}
Goals: ${promptData.goals}
Meals per day: ${promptData.mealCount}
Allergies: ${promptData.allergies}
Diet: ${promptData.diet}
