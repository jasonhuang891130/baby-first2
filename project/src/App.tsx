...
import { Baby, LogIn, LogOut, User, Book, FileText, Star, HelpCircle, Menu, X as XIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      <nav className="bg-white sticky top-0 z-40 shadow-sm">
        ...
        {/* Mobile menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 py-2 px-4 space-y-2">
            <button 
              onClick={handleCreatePlan}
              className="w-full text-left px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 rounded-lg"
            >
              Create Plan
            </button>
            <button 
            ...
            <button 
              onClick={handleGuides}
              className="w-full text-left px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-50 rounded-lg flex items-center gap-2"
            >
              <Book size={18} />
              Guides
            </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
          <div className="text-center space-y-8">
            <div className="inline-flex items-center flex-wrap justify-center gap-2">
              <span className="bg-yellow-500 text-black px-4 py-2 rounded-full font-medium text-sm md:text-base">
                SMART FOOD PLANNING
              </span>
              <span className="text-gray-600 flex items-center text-sm md:text-base">
            ...
            <div>
              <button 
                onClick={handleCreatePlan}
                className="bg-black text-white px-6 py-3 md:px-8 md:py-4 rounded-full text-base md:text-lg font-medium hover:bg-gray-800"
              >
          ...
          <div ref={featureCardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mt-12 md:mt-20 px-4">
            <div className="feature-card bg-white p-6 md:p-8 rounded-2xl shadow-lg transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold mb-4 text-center">Age-Appropriate</h4>
            ...
            <div className="feature-card bg-white p-6 md:p-8 rounded-2xl shadow-lg transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold mb-4 text-center">Nutritionist-Approved</h4>
              <p className="text-gray-600 text-center">
            ...
            <div className="feature-card bg-white p-6 md:p-8 rounded-2xl shadow-lg transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold mb-4 text-center">Easy to Follow</h4>
              <p className="text-gray-600 text-center">
